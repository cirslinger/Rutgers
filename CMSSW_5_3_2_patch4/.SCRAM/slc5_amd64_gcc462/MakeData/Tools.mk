...
boost             := boost
ALL_TOOLS      += boost
boost_LOC_INCLUDE := /cms/base/cmssoft/slc5_amd64_gcc462/external/boost/1.47.0/include
...
boost_header_LOC_INCLUDE := /cms/base/cmssoft/slc5_amd64_gcc462/external/boost/1.47.0/include
...
boost_python_LOC_INCLUDE := /cms/base/cmssoft/slc5_amd64_gcc462/external/boost/1.47.0/include
...
bz2lib             := bz2lib
ALL_TOOLS      += bz2lib
bz2lib_LOC_INCLUDE := /cms/base/cmssoft/slc5_amd64_gcc462/external/bz2lib/1.0.5/include
...
cascade_headers_LOC_INCLUDE := /cms/base/cmssoft/slc5_amd64_gcc462/external/cascade/2.2.04-cms/include
...
castor_header_LOC_INCLUDE := /cms/base/cmssoft/slc5_amd64_gcc462/external/castor/2.1.9.8/include /cms/base/cmssoft/slc5_amd64_gcc462/external/castor/2.1.9.8/include/shift
...
charybdis             := charybdis
ALL_TOOLS      += charybdis
charybdis_LOC_INCLUDE := /cms/base/cmssoft/slc5_amd64_gcc462/external/charybdis/1.003-cms/include
...
classlib             := classlib
ALL_TOOLS      += classlib
classlib_LOC_INCLUDE := /cms/base/cmssoft/slc5_amd64_gcc462/external/classlib/3.1.3/include
...
clhep             := clhep
ALL_TOOLS      += clhep
clhep_LOC_INCLUDE := /cms/base/cmssoft/slc5_amd64_gcc462/external/clhep/2.0.4.6/include
...
clhepheader_LOC_INCLUDE := /cms/base/cmssoft/slc5_amd64_gcc462/external/clhep/2.0.4.6/include
...
cppunit             := cppunit
ALL_TOOLS      += cppunit
cppunit_LOC_INCLUDE := /cms/base/cmssoft/slc5_amd64_gcc462/external/cppunit/1.12.1/include
...
curl             := curl
ALL_TOOLS      += curl
curl_LOC_INCLUDE := /cms/base/cmssoft/slc5_amd64_gcc462/external/curl/7.21.6/include
...
dpm             := dpm
ALL_TOOLS      += dpm
dpm_LOC_INCLUDE := /cms/base/cmssoft/slc5_amd64_gcc462/external/dpm/1.8.0.1/include
dpm_EX_INCLUDE  := $(dpm_LOC_INCLUDE)
dpm_LOC_LIB := dpm
dpm_EX_LIB  := $(dpm_LOC_LIB)
dpm_LOC_LIBDIR := /cms/base/cmssoft/slc5_amd64_gcc462/external/dpm/1.8.0.1/lib
...
evtgenlhc             := evtgenlhc
ALL_TOOLS      += evtgenlhc
evtgenlhc_LOC_INCLUDE := /cms/base/cmssoft/slc5_amd64_gcc462/external/evtgenlhc/9.1
...
expat             := expat
ALL_TOOLS      += expat
expat_LOC_INCLUDE := /cms/base/cmssoft/slc5_amd64_gcc462/external/expat/2.0.1/include
...
fastjet             := fastjet
ALL_TOOLS      += fastjet
fastjet_LOC_INCLUDE := /cms/base/cmssoft/slc5_amd64_gcc462/external/fastjet/3.0.1-cms2/include
...
fftjet             := fftjet
ALL_TOOLS      += fftjet
fftjet_LOC_INCLUDE := /cms/base/cmssoft/slc5_amd64_gcc462/external/fftjet/1.3.1/include
...
fftw3             := fftw3
ALL_TOOLS      += fftw3
fftw3_LOC_INCLUDE := /cms/base/cmssoft/slc5_amd64_gcc462/external/fftw3/3.2.2/include
...
frontier_client_LOC_INCLUDE := /cms/base/cmssoft/slc5_amd64_gcc462/external/frontier_client/2.8.5/include
...
gdbm             := gdbm
ALL_TOOLS      += gdbm
gdbm_LOC_INCLUDE := /cms/base/cmssoft/slc5_amd64_gcc462/external/gdbm/1.8.3/include
...
geant4core_LOC_INCLUDE := /cms/base/cmssoft/slc5_amd64_gcc462/external/geant4/9.4.p03-cms/include
...
gsl             := gsl
ALL_TOOLS      += gsl
gsl_LOC_INCLUDE := /cms/base/cmssoft/slc5_amd64_gcc462/external/gsl/1.10/include
...
hepmc_headers_LOC_INCLUDE := /cms/base/cmssoft/slc5_amd64_gcc462/external/hepmc/2.06.07/include
...
heppdt             := heppdt
ALL_TOOLS      += heppdt
heppdt_LOC_INCLUDE := /cms/base/cmssoft/slc5_amd64_gcc462/external/heppdt/3.03.00/include
...
herwig             := herwig
ALL_TOOLS      += herwig
herwig_LOC_INCLUDE := /cms/base/cmssoft/slc5_amd64_gcc462/external/herwig/6.520-cms/include
...
herwigpp             := herwigpp
ALL_TOOLS      += herwigpp
herwigpp_LOC_INCLUDE := /cms/base/cmssoft/slc5_amd64_gcc462/external/herwigpp/2.5.0-cms2/include
...
jemalloc             := jemalloc
ALL_TOOLS      += jemalloc
jemalloc_LOC_INCLUDE := /cms/base/cmssoft/slc5_amd64_gcc462/external/jemalloc/2.2.2/include
...
jimmy_headers_LOC_INCLUDE := /cms/base/cmssoft/slc5_amd64_gcc462/external/jimmy/4.2-cms/include
...
ktjet             := ktjet
ALL_TOOLS      += ktjet
ktjet_LOC_INCLUDE := /cms/base/cmssoft/slc5_amd64_gcc462/external/ktjet/1.06/include
...
lhapdf             := lhapdf
ALL_TOOLS      += lhapdf
lhapdf_LOC_INCLUDE := /cms/base/cmssoft/slc5_amd64_gcc462/external/lhapdf/5.8.5-cms/include
...
libhepml             := libhepml
ALL_TOOLS      += libhepml
libhepml_LOC_INCLUDE := /cms/base/cmssoft/slc5_amd64_gcc462/external/libhepml/0.2.1/interface
...
libjpg             := libjpg
ALL_TOOLS      += libjpg
libjpg_LOC_INCLUDE := /cms/base/cmssoft/slc5_amd64_gcc462/external/libjpg/8b/include
...
libpng             := libpng
ALL_TOOLS      += libpng
libpng_LOC_INCLUDE := /cms/base/cmssoft/slc5_amd64_gcc462/external/libpng/1.2.46/include
...
libtiff             := libtiff
ALL_TOOLS      += libtiff
libtiff_LOC_INCLUDE := /cms/base/cmssoft/slc5_amd64_gcc462/external/libtiff/3.9.4/include
...
libungif             := libungif
ALL_TOOLS      += libungif
libungif_LOC_INCLUDE := /cms/base/cmssoft/slc5_amd64_gcc462/external/libungif/4.1.4/include
...
llvm             := llvm
ALL_TOOLS      += llvm
llvm_LOC_INCLUDE := /cms/base/cmssoft/slc5_amd64_gcc462/external/llvm/3.2/include
...
mcdb             := mcdb
ALL_TOOLS      += mcdb
mcdb_LOC_INCLUDE := /cms/base/cmssoft/slc5_amd64_gcc462/external/mcdb/1.0.2/interface
...
meschach             := meschach
ALL_TOOLS      += meschach
meschach_LOC_INCLUDE := /cms/base/cmssoft/slc5_amd64_gcc462/external/meschach/1.2.pCMS1/include
...
mimetic             := mimetic
ALL_TOOLS      += mimetic
mimetic_LOC_INCLUDE := /cms/base/cmssoft/slc5_amd64_gcc462/external/mimetic/0.9.6/include
...
openssl             := openssl
ALL_TOOLS      += openssl
openssl_LOC_INCLUDE := /cms/base/cmssoft/slc5_amd64_gcc462/external/openssl/0.9.8e/include
...
oracle             := oracle
ALL_TOOLS      += oracle
oracle_LOC_INCLUDE := /cms/base/cmssoft/slc5_amd64_gcc462/external/oracle/100.0/include
...
pcre             := pcre
ALL_TOOLS      += pcre
pcre_LOC_INCLUDE := /cms/base/cmssoft/slc5_amd64_gcc462/external/pcre/7.9/include
...
photos_headers_LOC_INCLUDE := /cms/base/cmssoft/slc5_amd64_gcc462/external/photos/215.5/include
...
protobuf             := protobuf
ALL_TOOLS      += protobuf
protobuf_LOC_INCLUDE := /cms/base/cmssoft/slc5_amd64_gcc462/external/protobuf/2.4.1/include
...
pythia6_headers_LOC_INCLUDE := /cms/base/cmssoft/slc5_amd64_gcc462/external/pythia6/426/include
...
pythia8             := pythia8
ALL_TOOLS      += pythia8
pythia8_LOC_INCLUDE := /cms/base/cmssoft/slc5_amd64_gcc462/external/pythia8/153-cms/include
...
python             := python
ALL_TOOLS      += python
python_LOC_INCLUDE := /cms/base/cmssoft/slc5_amd64_gcc462/external/python/2.6.4/include/python2.6
...
qt             := qt
ALL_TOOLS      += qt
qt_LOC_INCLUDE := /cms/base/cmssoft/slc5_amd64_gcc462/external/qt/4.6.3/include/QtOpenGL /cms/base/cmssoft/slc5_amd64_gcc462/external/qt/4.6.3/include/QtGui
...
qt3support_LOC_INCLUDE := /cms/base/cmssoft/slc5_amd64_gcc462/external/qt/4.6.3/include/Qt3Support
...
qtbase             := qtbase
ALL_TOOLS      += qtbase
qtbase_LOC_INCLUDE := /cms/base/cmssoft/slc5_amd64_gcc462/external/qt/4.6.3/include /cms/base/cmssoft/slc5_amd64_gcc462/external/qt/4.6.3/include/Qt /cms/base/cmssoft/slc5_amd64_gcc462/external/qt/4.6.3/include/QtCore /cms/base/cmssoft/slc5_amd64_gcc462/external/qt/4.6.3/include/QtXml
...
qtdesigner_LOC_INCLUDE := /cms/base/cmssoft/slc5_amd64_gcc462/external/qt/4.6.3/include/QtDesigner
...
qtextra             := qtextra
ALL_TOOLS      += qtextra
qtextra_LOC_INCLUDE := /cms/base/cmssoft/slc5_amd64_gcc462/external/qt/4.6.3/include/QtScript
...
rivet             := rivet
ALL_TOOLS      += rivet
rivet_LOC_INCLUDE := /cms/base/cmssoft/slc5_amd64_gcc462/external/rivet/1.5.1-cms3/include
...
roofitcore_LOC_INCLUDE := /cms/base/cmssoft/slc5_amd64_gcc462/lcg/roofit/5.32.03-cms4/include
...
rootcint             := rootcint
ALL_TOOLS      += rootcint
rootcint_LOC_INCLUDE := /cms/base/cmssoft/slc5_amd64_gcc462/lcg/root/5.32.00-cms9/cint
...
self             := self
ALL_TOOLS      += self
self_LOC_INCLUDE := /cms/base/cmssoft/slc5_amd64_gcc462/cms/cmssw-patch/CMSSW_5_3_2_patch4/src /cms/base/cmssoft/slc5_amd64_gcc462/cms/cmssw-patch/CMSSW_5_3_2_patch4/include/LCG
self_EX_INCLUDE  := $(self_LOC_INCLUDE)
self_LOC_LIBDIR := /cms/base/cmssoft/slc5_amd64_gcc462/cms/cmssw-patch/CMSSW_5_3_2_patch4/lib/slc5_amd64_gcc462 /cms/base/cmssoft/slc5_amd64_gcc462/cms/cmssw-patch/CMSSW_5_3_2_patch4/external/slc5_amd64_gcc462/lib
...
sherpa             := sherpa
ALL_TOOLS      += sherpa
sherpa_LOC_INCLUDE := /cms/base/cmssoft/slc5_amd64_gcc462/external/sherpa/1.3.1-cms2/include/SHERPA-MC
...
sigcpp             := sigcpp
ALL_TOOLS      += sigcpp
sigcpp_LOC_INCLUDE := /cms/base/cmssoft/slc5_amd64_gcc462/external/sigcpp/2.2.10/include/sigc++-2.0
...
sqlite             := sqlite
ALL_TOOLS      += sqlite
sqlite_LOC_INCLUDE := /cms/base/cmssoft/slc5_amd64_gcc462/external/sqlite/3.6.23/include
...
tauola_headers_LOC_INCLUDE := /cms/base/cmssoft/slc5_amd64_gcc462/external/tauola/27.121.5/include
...
tauolapp             := tauolapp
ALL_TOOLS      += tauolapp
tauolapp_LOC_INCLUDE := /cms/base/cmssoft/slc5_amd64_gcc462/external/tauolapp/1.0.5-cms/include
...
thepeg             := thepeg
ALL_TOOLS      += thepeg
thepeg_LOC_INCLUDE := /cms/base/cmssoft/slc5_amd64_gcc462/external/thepeg/1.7.0-cms2/include
...
tkonlinesw_LOC_INCLUDE := /cms/base/cmssoft/slc5_amd64_gcc462/external/tkonlinesw/2.7.0-cms3/include
...
toprex_headers_LOC_INCLUDE := /cms/base/cmssoft/slc5_amd64_gcc462/external/toprex/4.23/include
...
uuid             := uuid
ALL_TOOLS      += uuid
uuid_LOC_INCLUDE := /cms/base/cmssoft/slc5_amd64_gcc462/external/uuid/1.38/include
...
valgrind             := valgrind
ALL_TOOLS      += valgrind
valgrind_LOC_INCLUDE := /cms/base/cmssoft/slc5_amd64_gcc462/external/valgrind/3.6.1/include
...
xdaq             := xdaq
ALL_TOOLS      += xdaq
xdaq_LOC_INCLUDE := /cms/base/cmssoft/slc5_amd64_gcc462/external/xdaq/VR17173/include /cms/base/cmssoft/slc5_amd64_gcc462/external/xdaq/VR17173/include/linux
...
xdaqheader_LOC_INCLUDE := /cms/base/cmssoft/slc5_amd64_gcc462/external/xdaq/VR17173/include
...
xerces-c             := xerces-c
ALL_TOOLS      += xerces-c
xerces-c_LOC_INCLUDE := /cms/base/cmssoft/slc5_amd64_gcc462/external/xerces-c/2.8.0/include
...
xrootd             := xrootd
ALL_TOOLS      += xrootd
xrootd_LOC_INCLUDE := /cms/base/cmssoft/slc5_amd64_gcc462/external/xrootd/3.1.0-cms2/include/xrootd
...
xz             := xz
ALL_TOOLS      += xz
xz_LOC_INCLUDE := /cms/base/cmssoft/slc5_amd64_gcc462/external/xz/5.0.3/include
...
zlib             := zlib
ALL_TOOLS      += zlib
zlib_LOC_INCLUDE := /cms/base/cmssoft/slc5_amd64_gcc462/external/zlib/1.2.3/include
